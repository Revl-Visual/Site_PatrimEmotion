      ...
      <main className="min-h-screen">
          ...
          <div className="container mx-auto px-4 max-w-6xl">
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-[#003662] rounded-2xl p-8 md:p-10 shadow-[0_4px_20px_rgba(0,0,0,0.08)] border-l-4 border-[#9FB620]">
                <h2 className="text-3xl font-serif font-semibold text-white mb-6 flex items-center gap-2">
        ...
        <section className="bg-[#003662] py-16 md:py-24">
          <div className="container mx-auto px-4 max-w-4xl">
            <h2 className="text-3xl font-serif font-semibold text-white mb-2 flex items-center gap-2">
              <span className="text-2xl" aria-hidden>🧠</span>
              1. Psychologie des différences individuelles
            </h2>
            ...
            <div className="space-y-6">
              <div className="bg-white/5 rounded-xl p-6 border-l-4 border-[#f4ca3a]">
                <h3 className="text-xl font-serif font-semibold text-[#f4ca3a] mb-3">
        ...
        <section className="section-alt-blue py-16 md:py-24">
          <div className="container mx-auto px-4 max-w-4xl">
            <h2 className="text-3xl font-serif font-semibold text-[#003662] mb-2 flex items-center gap-2">
              <span className="text-2xl" aria-hidden>📊</span>
              2. Finance comportementale
            </h2>
            <p className="text-[#003662] leading-relaxed mb-8 text-lg">
            ...
            <h3 className="text-xl font-serif font-semibold text-[#003662] mb-4">
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3 p-4 rounded-xl bg-[#003662]/5 border-l-4 border-[#9FB620]">
                ...
                <span className="text-[#003662] leading-relaxed"><strong className="text-[#9FB620]">Aversion à la perte</strong> — Réaction face à une baisse d&apos;actif (vendre trop tôt ou conserver trop longtemps une moins-value) ; la décision est souvent guidée par le soulagement de la tension plutôt que par la stratégie.</span>
              </li>
              <li className="flex items-start gap-3 p-4 rounded-xl bg-[#003662]/5 border-l-4 border-[#9FB620]">
                <span className="text-[#9FB620] font-semibold shrink-0 text-lg">•</span>
                <span className="text-[#003662] leading-relaxed"><strong className="text-[#9FB620]">Surconfiance</strong> — Surestimer sa capacité d&apos;anticipation, privilégier l&apos;intuition ou une concentration excessive sur un secteur « maîtrisé » ; le conseil joue un rôle de contrepoint pour une allocation cohérente.</span>
              </li>
              <li className="flex items-start gap-3 p-4 rounded-xl bg-[#003662]/5 border-l-4 border-[#9FB620]">
                <span className="text-[#9FB620] font-semibold shrink-0 text-lg">•</span>
                <span className="text-[#003662] leading-relaxed"><strong className="text-[#9FB620]">Biais de confirmation</strong> — Rechercher les informations qui vont dans le sens de l&apos;option envisagée ; le conseiller aide à envisager tous les scénarios pour une décision éclairée.</span>
              </li>
              <li className="flex items-start gap-3 p-4 rounded-xl bg-[#003662]/5 border-l-4 border-[#9FB620]">
                <span className="text-[#9FB620] font-semibold shrink-0 text-lg">•</span>
                <span className="text-[#003662] leading-relaxed"><strong className="text-[#9FB620]">Court terme</strong> — Réagir à l&apos;actualité plutôt que piloter ; la fiscalité ou les annonces peuvent orienter la décision sans que l&apos;impact global soit mesuré.</span>
              </li>
              <li className="flex items-start gap-3 p-4 rounded-xl bg-[#003662]/5 border-l-4 border-[#9FB620]">
                <span className="text-[#9FB620] font-semibold shrink-0 text-lg">•</span>
                <span className="text-[#003662] leading-relaxed"><strong className="text-[#9FB620]">Ancrage, disponibilité, effet de disposition</strong> — Donner trop de poids à une référence ou à l&apos;information disponible ; garder trop longtemps des moins-values et réaliser trop tôt les plus-values. PatrimEmotion® aide à en prendre conscience.</span>
              </li>
            </ul>
          </div>
        </section>
        ...
        <section className="bg-[#003662] py-16 md:py-24">
          <div className="container mx-auto px-4 max-w-4xl">
            <h2 className="text-3xl font-serif font-semibold text-white mb-2 flex items-center gap-2">
              <span className="text-2xl" aria-hidden>🎯</span>
              3. Théorie de la décision sous incertitude
            </h2>
            <p className="text-white leading-relaxed mb-8 text-lg">
        ...
        <section className="section-alt-blue py-16 md:py-24">
          <div className="container mx-auto px-4 max-w-4xl">
            <div className="bg-[#003662] rounded-2xl p-8 md:p-10 shadow-[0_4px_20px_rgba(0,0,0,0.08)] border-l-4 border-[#f4ca3a]">
              <h2 className="text-3xl font-serif font-semibold text-white mb-2 flex items-center gap-2">
                <span className="text-2xl" aria-hidden>📐</span>
                4. Modèle de scoring psychométrique
              </h2>
              ...
              <p className="text-[#f4ca3a] font-semibold mb-4 text-lg">
          ...
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-[#9FB620] rounded-xl p-6 md:p-8">
                ...
                <ul className="space-y-2 text-white">
                  <li className="flex items-start gap-2">
                    <span className="text-[#003662] font-semibold shrink-0">✓</span>
              ...
              <div className="bg-white/10 rounded-xl p-6 md:p-8 border border-white/20">
                <h3 className="text-xl font-serif font-semibold text-[#f4ca3a] mb-4">
