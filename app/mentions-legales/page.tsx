        ...
        <section className="section-alt-blue py-16 md:py-24">
          <div className="container mx-auto px-4 max-w-4xl">
            <div className="space-y-8 text-[#003662]/90 text-lg leading-relaxed">
              <div>
                <h2 className="text-2xl font-serif font-bold text-[#003662] mb-4">Éditeur du site</h2>
                <p>AM Courtage & Patrimoine (AMCP)</p>
                <p>[Adresse à compléter]</p>
                <p>[SIRET à compléter]</p>
              </div>
              <div>
                <h2 className="text-2xl font-serif font-bold text-[#003662] mb-4">Directeur de publication</h2>
                <p>Aurélie - AM Courtage & Patrimoine (AMCP)</p>
              </div>
              <div>
                <h2 className="text-2xl font-serif font-bold text-[#003662] mb-4">Hébergement</h2>
