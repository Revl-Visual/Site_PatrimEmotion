  ...
  return (
    <>
      ...
      <main className="min-h-screen">
        ...
        <section className="section-alt-blue pt-16 !pb-24 md:pt-24 md:!pb-32">
          <div className="container mx-auto px-4 max-w-6xl">
            <div className="grid md:grid-cols-2 gap-8">
              <div className="no-justify bg-[#003662] rounded-2xl p-8 md:p-10 shadow-[0_4px_20px_rgba(0,0,0,0.08)] border-l-4 border-[#9FB620]">
                <h2 className="pe-heading-section text-white mb-6">
                  Cadre <span className="text-[#9FB620]">éthique</span>
                </h2>
                <p className="pe-body-lead !text-left [text-align-last:auto] text-white leading-relaxed mb-6">
                ...
                <p className="pe-body-lead !text-left [text-align-last:auto] text-white leading-relaxed">
              ...
              <div className="no-justify bg-[#003662] rounded-2xl p-8 md:p-10 shadow-[0_4px_20px_rgba(0,0,0,0.08)] border-l-4 border-[#f4ca3a]">
                <h2 className="pe-heading-section text-white mb-6">
                  Base <span className="text-[#f4ca3a]">scientifique</span>
                </h2>
                <p className="pe-body-lead !text-left [text-align-last:auto] text-white leading-relaxed mb-4">
        ...
        <section className="bg-[#003662] py-16 md:py-24">
          <div className="container mx-auto px-4 max-w-4xl">
            <h2 className="pe-heading-section -mt-1 md:-mt-2 text-[#f4ca3a] mb-5">
        ...
        <section className="section-alt-blue py-16 md:py-24">
          <div className="container mx-auto px-4 max-w-4xl">
            <h2 className="pe-heading-section text-[#9FB620] mb-5">
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3 p-4 rounded-xl bg-[#f8fbed] border-l-4 border-[#9FB620]">
        ...
        <section className="bg-[#003662] py-16 md:py-24">
          <div className="container mx-auto px-4 max-w-4xl">
            <h2 className="pe-heading-section text-white mb-5">
              Théorie de la décision sous incertitude
            </h2>
            <p className="pe-body-lead text-white leading-relaxed mb-8">
              PatrimEmotion® ne mesure pas la performance financière : elle mesure la <strong className="font-bold text-white">posture décisionnelle</strong> face à l&apos;incertitude patrimoniale. <strong className="font-bold text-white">Trois axes</strong> sont au cœur du cadre scientifique.
            </p>

            <div className="space-y-6">
              <div className="bg-white/10 rounded-xl p-6 border-l-4 border-[#f4ca3a]">
                <h3 className="pe-heading-card mb-3 font-medium text-white">
                  Théorie des perspectives (Kahneman & Tversky)
                </h3>
                <p className="pe-body-lead text-white leading-relaxed">
                  On ne décide pas en valeur absolue mais par rapport à un <strong className="font-bold text-white">point de référence</strong> (gains/pertes perçus). Les <strong className="font-bold text-white">pertes pèsent plus que les gains</strong> (aversion aux pertes). Sensibilité décroissante, <strong className="font-bold text-white">effet de cadrage</strong> et pondération subjective des probabilités : le vocabulaire et la mise en scène influencent le choix.
                </p>
              </div>
              <div className="bg-white/10 rounded-xl p-6 border-l-4 border-[#f4ca3a]">
                <h3 className="pe-heading-card mb-3 font-medium text-white">
                ...
                <p className="pe-body-lead text-white leading-relaxed">
                  La décision est un <strong className="font-bold text-white">compromis</strong> entre sécurité (stabilité, protection du capital) et risque (rendement, opportunité). <strong className="font-bold text-white">Tolérance au risque</strong> (trait stable) vs <strong className="font-bold text-white">capacité à prendre du risque</strong> (contraintes objectives). Risque perçu ≠ risque réel ; l&apos;ambiguïté augmente le besoin de sécurité.
                </p>
              </div>
              <div className="bg-white/10 rounded-xl p-6 border-l-4 border-[#f4ca3a]">
                <h3 className="pe-heading-card mb-3 font-medium text-white">
                ...
                <p className="pe-body-lead text-white leading-relaxed">
                  <strong className="font-bold text-white">Préférence temporelle</strong> : on valorise souvent le présent plus que le futur. Biais du présent, incohérences dynamiques. Plus l&apos;<strong className="font-bold text-white">horizon</strong> est long et crédible, plus on accepte la volatilité. Sécuriser la décision, c&apos;est rendre le futur concret (étapes, jalons, scénarios, règles de pilotage).
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="section-alt-blue py-16 md:py-24">
          <div className="container mx-auto px-4 max-w-4xl">
            <div className="bg-[#003662] rounded-2xl p-8 md:p-10 shadow-[0_4px_20px_rgba(0,0,0,0.08)] border-l-4 border-[#f4ca3a]">
              <h2 className="pe-heading-section text-[#f4ca3a] mb-5">
        ...
        <section className="bg-[#003662] py-16 md:py-24">
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            <div className="mt-10 text-center">
              <p className="pe-body-lead pe-lead-centered text-white/90 leading-relaxed max-w-2xl mx-auto">
        ...
        <section className="section-alt-blue py-16 md:py-24">
          <div className="container mx-auto px-4 max-w-4xl">
            <div className="bg-[#003662] rounded-2xl p-8 md:p-10 shadow-[0_4px_20px_rgba(0,0,0,0.08)] border-l-4 border-[#9FB620]">
              <h2 className="pe-heading-section text-[#9FB620] mb-6">
                Méthode opérationnelle
              </h2>
              <p className="pe-body-lead text-white leading-relaxed mb-6">
